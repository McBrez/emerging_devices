...
\gibberish{
Fabrication methods include additive and reducing processes. For the extreme thin films, that are required for gas sensors, mostly reducing methods are used, as the control of the layer height is much finer. The most prominent 2D film fabrication methods are \gls{mbe}, transfer methods like \gls{dep}, \gls{cvd} and its specialiced method \gls{ald}. Their advantages and disadvantages shall be briefly discussed here. 
